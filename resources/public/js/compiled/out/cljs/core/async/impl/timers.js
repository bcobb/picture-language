...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__12106__auto__,writer__12107__auto__,opt__12108__auto__){return cljs.core._write.call(null,writer__12107__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_21694 = (0);while(true){
if((i_21694 < arr.length))
{(arr[i_21694] = null);
{
var G__21695 = (i_21694 + (1));
i_21694 = G__21695;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__12106__auto__,writer__12107__auto__,opt__12108__auto__){return cljs.core._write.call(null,writer__12107__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_21701 = (self__.level + (1));while(true){
if((i_21701 <= (new_level + (1))))
{(update[i_21701] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_21703 = (0);while(true){
if((i_21703 <= self__.level))
{var links_21704 = (update[i_21703]).forward;if(((links_21704[i_21703]) === x__$1))
{(links_21704[i_21703] = (x__$1.forward[i_21703]));
{
var G__21705 = (i_21703 + (1));
i_21703 = G__21705;
continue;
}
} else
{{
var G__21706 = (i_21703 + (1));
i_21703 = G__21706;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__11529__auto__ = (cljs.core.truth_((function (){var and__11517__auto__ = me;if(cljs.core.truth_(and__11517__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__11517__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__11529__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__11529__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__11529__auto__,timeout__$1,me))
,msecs);
